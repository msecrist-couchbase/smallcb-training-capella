...
One time setup/init/build steps...
    ...
    # to create the vol-snapshot subdirectory...
    make create

    # 3) Compile the golang web/app server...
    make play-server

Invoke whenever the host is launched...

    # Starts or restarts the docker container instance,
