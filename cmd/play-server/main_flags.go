...
var (
	...
	serverTools = flag.String("serverTools", "couchbase-server couchdb gometa goport gosecrets goxdcr gozip cbas cbft cbft-bleve backup indexer install eventing-consumer eventing-producer "+
		"memcached projector prometheus mobile-service "+
		"couch_view_file_merger couch_view_group_cleanup couch_view_group_compactor couch_view_index_builder couch_view_index_updater couchfile_upgrade cbq-engine couchjs ct_run "+
